...
export default function About() {
  return (
    <div className="max-w-2xl mx-auto px-6 sm:px-8 py-6">
      ...
      <p>
        I'm a New York City based junior at Yale University pursuing a combined B.S./M.S. in Computer Science, along with certificates in Chinese Language and Ethnography. I am working as a Software Engineering Intern at Dow Jones building AI powered e2e testing tools, maintaining the WSJ website, and creating Index-Design system component libraries for multiple Dow Jones brands. Previously, I was a Machine Learning Research Intern at HKUST, where I researched retrieval-augmented generation systems and explored techniques for reducing hallucinations and improving multi-hop reasoning in large language models. I am looking for Fall 2026 and Summer 2027 internship opportunities.
        <br></br> <br></br>
