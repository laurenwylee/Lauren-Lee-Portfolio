...
export default function Projects()
{
    return (
        <div className="m-6">
            ...
            <div>
                <ProjectComponent projectName="PointMaxxer" projectImage="" description="PointMaxxer is a personalized credit card rewards optimizer that helps users choose the best card for each purchase, track points, and explore redemption opportunities." stack={["Next.js", "TypeScript", "Supabase"]} githubLink="https://github.com/laurenwylee/Credit-Card-Point-Optimizer" websiteLink="https://credit-card-point-optimizer.vercel.app/dashboard" videoLink="https://www.loom.com/share/0f33996a8dc54d1995a956e4a64b9928"/>
